...
public class MD5Util {
    ...
    public static void main(String[] args) {
        System.out.println(contains("123456",""));
       // System.out.println("加密前： " + pwd);
       // System.err.println("加密后： " + MD5Util.getMD5(pwd));
    }

    private static boolean contains(String address, String name){
        return Arrays.stream(name.split(",")).anyMatch(na->address.contains("".equals(na)?"!@#":na));
    }
